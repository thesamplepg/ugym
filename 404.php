...
<main class="main-page bg-slate-100">

  <div class="comtainer mx-auto h-dvh">
    <div class="w-full h-full flex items-center justify-center">
      <div class="p-10 bg-white rounded-2xl shadow-sm flex flex-col items-center">
        <svg class="size-16 text-orange-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        <h2 class="mt-5 font-semibold text-xl text-center text-slate-600">Страница не найдена</h2>
        <a class="text-orange-600 mt-1" href="<?php echo home_url(); ?>">На главную</a> 
      </div>
    </div>
  </div>

<section class="py-8">
  <div class="comtainer mx-auto">
    ...
    <div class="p-7 grid grid-cols-1 bg-white rounded-2xl shadow-sm w-full md:w-1/2">
      ...
      г. Москва, район Южное Бутово, улица Южнобутовская, 2, ТРЦ "Аквамолл", 5 этаж
      ...
      <a class="py-5 border-b text-orange-600" href="#">+996 990-90-90</a>
      <p class="py-5 border-b">Ежедневно с 6 до 24</p>

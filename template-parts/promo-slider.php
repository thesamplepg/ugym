  ...
  <div class="comtainer mx-auto">
    <div class="promo-swiper swiper h-[350px] md:h-[400px] rounded-2xl shadow group">
      <div class="absolute z-10 w-full h-full p-6 md:p-10 flex items-end">
        <div class="w-full h-full lg:w-2/3 flex flex-col">
          <div class="promo-swiper_text grow relative text-3xl md:text-4xl">
            <h2 class="absolute bottom-0 animate__animated animate__faster text-white font-bold uppercase">66% скидки по промокоду UGYM1 до 01.02</h2>
            <h2 class="absolute bottom-0 animate__animated animate__faster opacity-0 text-white font-bold uppercase">Бесплатное первое занятие с тренером</h2>
          </div>
          <section class="flex items-center mt-4 gap-4">
            <a class="shadow text-white bg-orange-600 px-8 py-3 rounded-full font-bold" href="#">Выбрать клуб</a>
      ...
      <div class="swiper-wrapper h-full">
        <div class="swiper-slide w-full h-full bg-center bg-cover bg-[url('https://www.ddxfitness.ru/upload/resize_cache/iblock/086/1920_620_2/3pqz3hb6f213opem3rm52ju308hhkup7.png')]">
        </div>
        <div class="swiper-slide w-full h-full bg-center bg-cover bg-[url('https://www.ddxfitness.ru/upload/resize_cache/iblock/58e/1920_620_2/bh08k77axh7sob0j4keitmbl1jb1oz08.png')]">
        </div>
      </div>
    </div>
  </div>

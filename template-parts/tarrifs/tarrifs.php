  ...
  <?php if ($query->have_posts()):
      while ($query->have_posts()):
          ...
          <div class="tarrif-block w-full md:w-[320px] py-8 px-6 bg-white rounded-2xl <?php echo $shadow; ?>">
            ...
            <?php endif; ?>
            <h3 class="text-3xl text-<?php echo $color; ?>-600 font-bold"><?php the_title(); ?></h3>
            ...
            <h4 class="tarrif-block_price mb-3 text-<?php echo $color; ?>-600 font-semibold">
              <span class="text-xl"><?php echo get_field(
                  'tarrifs_price',
              ); ?></span> в месяц
            </h4>
            <a href="#" data-modal-ref="#modal-buy" data-input-key="tarrif" data-input-value="<?php the_title(); ?>" class="modal-handler tarrif-block_btn px-8 py-3 block text-center bg-<?php echo $color; ?>-600 text-white font-semibold rounded-full">
              Купить
            </a>
          </div>
  <?php
